...
const btnContainer = document.querySelector(".btnContenedor");
...
const divContainer = document.querySelector(".contenedor");
...
const animals = [
  ...
  },
  {
    ...
    imageSrc: "./imagenes/pantera-negra.jpg",
  },
  {
    name: "El Jaguar",
    description:
